...
public struct DiscordWebhookMessage: Codable {
...
public struct DiscordEmbedField: Codable {
...
public struct DiscordEmbedFooter: Codable {
...
public struct DiscordEmbedImage: Codable {
    /// The URL of the image.
    public var url: String?
}

/// Represents the author of a Discord embed.
public struct DiscordEmbedAuthor: Codable {
...
public struct DiscordEmbedProvider: Codable {
...
public struct DiscordEmbedVideo: Codable {
